...
<html lang="ja">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-sm navbar-light bg-light">
            <!-- ホームリンク　ブランドロゴ -->
            <a class="navbar-brand">サンプル株式会社</a>
            <!-- ハンバーガーボタン -->
            ...
            <div class="collapse navbar-collapse justify-content-end" id="nav-bar">
                <ul class="navbar-nav" style="list-style: none;">
                    <li class="nav-item"><a class="nav-link">会社情報</a></li>
                    <li class="nav-item"><a class="nav-link">ニュース</a></li>
                    <li class="nav-item"><a class="nav-link">採用情報</a></li>
                    <li class="nav-item active"><a href="contact.html" class="nav-link"><font color="black">お問い合わせ</font></a></li>
                </ul>
            </div>
        </nav>
        </header>
        <div class="container">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong><i class="far fa-clock"></i>営業時間</strong>
                        </div>
                        <div class="card-body">
            ...
            <div class="mt-4 row">
                <div class="col-sm-2">
                    <strong><i class="fas fa-envelope"></i>メール：</strong>
                </div>
                <div class="col-sm-10">
                    <p>
                    ...
                    <form method="post" action="complete.php">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">会社名：</label>
                            <div class="col-sm-10">
